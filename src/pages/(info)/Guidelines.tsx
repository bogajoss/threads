...
const Guidelines: React.FC = () => {
  return (
    <div className="space-y-6">
      <h1 className="text-4xl font-extrabold tracking-tight lg:text-5xl">Community Guidelines</h1>
      <p className="text-xl text-zinc-500">How we keep Sysm safe and welcoming.</p>
