        ...
        {systems.map((system) => (
          ...
          >
            <div className="space-y-1">
              ...
              {system.message && (
                <p className="text-sm text-zinc-500">{system.message}</p>
              )}
            </div>
      ...
      <section className="space-y-4 pt-8">
        ...
        <div className="space-y-6">
          <div className="relative border-l-2 border-zinc-100 pl-6 dark:border-zinc-800">
            ...
            <h3 className="mt-1 font-bold text-black dark:text-white">
              Intermittent Login Delays
            </h3>
            <p className="mt-2 text-sm text-zinc-500">
              We are investigating reports of slow login times. Our team is
              working on a fix.
            </p>
          </div>
        </div>
