...
import { ChevronLeft, Camera, User, FileText, MapPin, Globe, Save } from "lucide-react";
...
const EditProfile: React.FC = () => {
  ...
  const [editProfileData, setEditProfileData] = useState<any>(currentUser || {});
             ...
             <div className="overflow-hidden rounded-2xl bg-zinc-50 dark:bg-zinc-900">
                ...
                <div className="flex items-center gap-6 p-4">
                   ...
                   <div className="flex-1">
                      <p className="text-sm font-bold dark:text-zinc-200">Profile Picture</p>
            ...
            <div className="divide-y divide-zinc-200 overflow-hidden rounded-2xl bg-zinc-50 dark:divide-zinc-800 dark:bg-zinc-900">
               <div className="flex flex-col gap-2 p-4">
                  <div className="flex items-center gap-2 text-zinc-500">
                    <User size={16} />
                    <label className="text-xs font-bold uppercase tracking-tight">Display Name</label>
                  </div>
                  <Input
               ...
               <div className="flex flex-col gap-2 p-4">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2 text-zinc-500">
                      <FileText size={16} />
                      <label className="text-xs font-bold uppercase tracking-tight">Bio</label>
                    </div>
                    <CircularProgress
                      current={wordCount}
                      max={60}
          ...
          <section className="space-y-4">
            ...
            <div className="divide-y divide-zinc-200 overflow-hidden rounded-2xl bg-zinc-50 dark:divide-zinc-800 dark:bg-zinc-900">
               <div className="flex flex-col gap-2 p-4">
                  <div className="flex items-center gap-2 text-zinc-500">
                    <MapPin size={16} />
                    <label className="text-xs font-bold uppercase tracking-tight">Location</label>
                  </div>
                  <Input
               ...
               <div className="flex flex-col gap-2 p-4">
                  <div className="flex items-center gap-2 text-zinc-500">
                    <Globe size={16} />
                    <label className="text-xs font-bold uppercase tracking-tight">Website</label>
                  </div>
                  <Input
