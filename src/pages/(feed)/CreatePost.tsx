  ...
  return (
    <PageTransition>
      <div className="flex min-h-screen flex-col bg-[--background] dark:bg-black md:rounded-3xl md:border md:border-[--border] md:shadow-sm">
        ...
        <form onSubmit={handleCreatePost} className="flex flex-1 flex-col gap-8 p-6 max-w-5xl w-full mx-auto font-bangla">
          {/* Caption Section */}
          ...
          <div className="flex flex-col gap-2.5">
            ...
            <div 
              ...
              className="group flex flex-col items-center justify-center gap-4 rounded-2xl border-2 border-dashed border-[--border] bg-zinc-50/30 py-12 transition-all hover:border-violet-500 hover:bg-violet-50/10 dark:bg-zinc-900/20 cursor-pointer"
            >
              <div className="rounded-2xl bg-[--background] p-4 shadow-sm ring-1 ring-[--border] transition-transform group-hover:scale-110">
                <ImageIcon className="text-violet-500" size={32} />
              </div>
              <div className="text-center space-y-1">
                <p className="text-base font-bold text-[--foreground] font-english">Click to upload or drag and drop</p>
                <p className="text-xs text-zinc-500 font-english">SVG, PNG, JPG or GIF (max. 800x400px)</p>
              </div>
            </div>
            <MediaUploader
