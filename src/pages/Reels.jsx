...
const ReelItem = ({ reel }) => (
    <div className="relative h-screen w-full bg-black snap-start flex items-center justify-center">
        <video src={reel.url} className="h-full w-full object-contain" loop autoPlay muted />
        <div className="absolute inset-0 bg-gradient-to-b from-black/20 via-transparent to-black/60" />
        <div className="absolute bottom-20 left-4 right-12 text-white">
            <div className="flex items-center gap-2 mb-3">
                <img src={reel.user.avatar} className="size-10 rounded-full border-2 border-white" alt="" />
        ...
        <div className="absolute bottom-20 right-2 flex flex-col items-center gap-6">
            <div className="flex flex-col items-center gap-1">
                ...
                <span className="text-white text-xs font-bold">{reel.stats.likes}</span>
            </div>
            <div className="flex flex-col items-center gap-1">
                ...
                <span className="text-white text-xs font-bold">{reel.stats.comments}</span>
            </div>
            <div className="flex flex-col items-center gap-1">
                ...
                <span className="text-white text-xs font-bold">{reel.stats.shares}</span>
            </div>
        </div>
    </div>
);
