...
const SidebarRight = () => {
    ...
    if (currentUser) {
        return (
            <aside className="sticky top-5 hidden max-h-screen w-[320px] shrink-0 flex-col gap-y-6 overflow-y-auto lg:flex">
    ...
    return (
        <aside className="sticky top-5 hidden w-[350px] shrink-0 flex-col gap-y-6 pr-4 lg:flex">
