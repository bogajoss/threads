    ...
    return (
        <div className="relative w-full aspect-[21/9] sm:aspect-[2.5/1] rounded-3xl overflow-hidden mb-6 group cursor-pointer">
            ...
            <div className="absolute bottom-6 left-8 text-white">
                ...
                <p className="text-sm sm:text-base font-medium opacity-90 tracking-wide drop-shadow-md">a social network built by <a href="https://t.me/systemadminbd" target="_blank" rel="noopener noreferrer" className="hover:underline">@Systemadminbd</a></p>
            </div>
