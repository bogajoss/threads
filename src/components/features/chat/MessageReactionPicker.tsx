                ...
                <div className="flex items-center gap-1">
                    {QUICK_EMOJIS.map((emoji) => (
                        <button
                            ...
                            className={`rounded-full p-2 text-xl transition-all hover:bg-zinc-100 active:scale-125 dark:hover:bg-zinc-800 ${currentReaction === emoji ? "bg-zinc-100 dark:bg-zinc-800" : ""
                                }`}
                        >
                            {emoji}
                        </button>
