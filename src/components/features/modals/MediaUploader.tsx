...
const SortableMediaItem: React.FC<SortableMediaItemProps> = ({
  ...
  return (
    <div
      ref={setNodeRef}
      style={style}
      className={`group relative overflow-hidden rounded-2xl border border-zinc-100 bg-zinc-100 shadow-sm transition-shadow dark:border-zinc-800 dark:bg-zinc-800 ${
  ...
  return (
    <div className="mb-4 animate-in fade-in zoom-in-95 duration-200">
      ...
      >
        ...
        >
          <div
            className={`grid gap-2 overflow-hidden rounded-2xl border border-zinc-100 shadow-sm dark:border-zinc-800 ${
