...
import { User, ShieldAlert, Ban, Trash2, ExternalLink, MapPin, Link as LinkIcon } from "lucide-react"
                ...
                <div className="space-y-6">
                    ...
                    <div className="flex flex-col items-center gap-4 border-b border-zinc-100 pb-6 dark:border-zinc-800">
                        ...
                        <div className="text-center space-y-1">
                            ...
                            <p className="text-sm font-medium text-zinc-500">@{user.handle}</p>
                        </div>

                        <Button variant="secondary" size="sm" className="rounded-full" onClick={handleViewProfile}>
                    ...
                    {(user.bio || user.location || user.website) && (
                        <div className="space-y-3 px-1">
                            <h4 className="text-xs font-bold uppercase tracking-wider text-zinc-400">About</h4>
                            <div className="space-y-2">
                                {user.bio && <p className="text-sm text-zinc-600 dark:text-zinc-300">{user.bio}</p>}
                    ...
                    <div className="space-y-2 pt-2">
                        <h4 className="text-xs font-bold uppercase tracking-wider text-zinc-400 px-1 mb-2">Privacy & Support</h4>
