...
const PostContent: React.FC<PostContentProps> = ({
            ...
            >
                <Textarea
                    ...
                    className={`min-h-[100px] w-full rounded-xl border-zinc-200 bg-zinc-50 focus:ring-violet-500 dark:border-zinc-800 dark:bg-zinc-900 ${
                        isBangla(editedContent || "") ? "font-bangla text-lg" : "font-english"
                    }`}
                    autoFocus
                />
    ...
    const textToProcess = shouldTruncate && !isExpanded ? content.substring(0, 280) : content

    return (
        <div
            className={cn(
                "whitespace-pre-line break-words",
                isDetail ? "text-lg leading-relaxed sm:text-xl sm:leading-8" : "text-[15px] leading-relaxed",
