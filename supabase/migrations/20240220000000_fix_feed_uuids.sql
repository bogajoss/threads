-- Fix invalid UUID generation for reposts in feed functions

-- 1. Fix get_posts_feed
...
BEGIN
  ...
  WITH feed_items AS (
    ...
    -- REPOSTS
    SELECT
      -- Generate a deterministic UUID from post_id and user_id
