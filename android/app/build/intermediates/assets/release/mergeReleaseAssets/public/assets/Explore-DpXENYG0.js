import { a as D } from "./rolldown-runtime-BaZ8gS7u.js";
import { E as B, c as H, d as V } from "./framework-CsA6nn9m.js";
import "./database-BiY55TQY.js";
import { En as q, Mt as W, en as G, vn as U } from "./ui-libs-Px4MBmNX.js";
...
import { n as ee } from "./post-oiE9jMza.js";
import "./text-processing-DFvQvkgt.js";
import "./linkify-BIniK2-v.js";
import { s as se } from "./hooks-wSD5Qk1m.js";
var te = H(),
  be = D(B(), 1),
  s = D(V(), 1),
  ae = () => {
    const e = (0, te.c)(50),
      {
        ...
        setActiveTab: M,
        isCreateModalOpen: E,
        setIsCreateModalOpen: l,
        communitiesData: I,
        isCommunitiesLoading: Q,
        isFetchingMoreCommunities: g,
        hasMoreCommunities: P,
        postsData: j,
        isPostsLoading: N,
        isFetchingMorePosts: k,
        hasMorePosts: S,
        filteredCommunities: z,
        handleCommunityClick: T,
        loadCommunities: L,
        loadPosts: $,
        navigate: _,
      } = se();
    if ((Q || N) && !I.length && !j.length) {
      let t;
      return (
    ...
    e[7] !== r || e[8] !== l
      ? ((c =
          ...
          (0, s.jsx)("button", {
            ...
            children: (0, s.jsx)(G, { size: 22, strokeWidth: 3 }),
          })),
        (e[7] = r),
        (e[8] = l),
        (e[9] = c))
    ...
    e[13] === Symbol.for("react.memo_cache_sentinel")
      ? ((C = (0, s.jsxs)(F, {
          ...
          children: [(0, s.jsx)(W, { size: 18 }), "Communities"],
        })),
        (e[13] = C))
      : (C = e[13]);
    let y;
      ...
      ? ((y = (0, s.jsxs)(Z, {
          ...
          children: [
            ...
            (0, s.jsxs)(F, {
              ...
              className:
                "flex h-full gap-2 rounded-none border-b-2 border-transparent px-2 font-bold text-zinc-500 transition-all data-[state=active]:border-violet-600 data-[state=active]:bg-transparent data-[state=active]:text-zinc-950 dark:data-[state=active]:text-white",
              children: [(0, s.jsx)(q, { size: 18 }), "Posts"],
            }),
          ],
        })),
        (e[14] = y))
    ...
    e[15] !== a || e[16] !== M
      ? ((x = (0, s.jsx)("div", {
          className: "border-t border-zinc-100 px-1 dark:border-zinc-800",
          children: (0, s.jsx)(X, {
            value: a,
            onValueChange: M,
            className: "w-full",
    ...
    e[18] !== m || e[19] !== x
      ? ((u = (0, s.jsxs)("div", {
          className:
            "sticky top-0 z-10 border-b border-zinc-100 bg-white/90 backdrop-blur-md dark:bg-black/90 dark:border-zinc-800",
          children: [m, x],
        })),
        (e[18] = m),
        (e[19] = x),
            ...
            children: [
              z.length > 0
                ? z.map((t) =>
                    (0, s.jsx)(
                      K,
                      { profile: t, onUserClick: T, isCommunity: !0 },
                      t.handle,
                    ),
                  )
                : (0, s.jsx)("div", {
              ...
              P &&
                ...
                (0, s.jsx)("div", {
                  className:
                    "flex justify-center border-t border-zinc-100 p-6 dark:border-zinc-800",
                  children: (0, s.jsxs)(O, {
                    variant: "secondary",
                    className: "w-full",
                    onClick: () => L(),
    ...
    e[38] !== f || e[39] !== h
      ...
      : (p = e[40]);
    let b;
    e[41] !== l ? ((b = () => l(!1)), (e[41] = l), (e[42] = b)) : (b = e[42]);
    let v;
    e[43] !== E || e[44] !== b
      ? ((v = (0, s.jsx)(Y, { isOpen: E, onClose: b })),
        (e[43] = E),
        (e[44] = b),
        (e[45] = v))
      : (v = e[45]);
