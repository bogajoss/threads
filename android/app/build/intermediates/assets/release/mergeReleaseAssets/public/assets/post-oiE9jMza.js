const __vite__mapDeps = (
  ...
  d = m.f ||
    (m.f = [
      "assets/VideoPlayer-dv5xP0OK.js",
      ...
      "assets/dist-CYPYLHr8.js",
    ]),
) => i.map((i) => d[i]);
import { a as ct } from "./rolldown-runtime-BaZ8gS7u.js";
import {
  C as dt,
  E as Ct,
  b as ie,
...
import { r as Ft } from "./query-QyXblnmD.js";
import {
  $t as je,
  Cn as Pt,
  Dn as Ue,
...
import { t as Ce } from "./text-processing-DFvQvkgt.js";
import { t as $e } from "./linkify-BIniK2-v.js";
import { p as Ns, u as et } from "./hooks-wSD5Qk1m.js";
var ws = O(),
  N = ct(Ct(), 1),
  t = ct($t(), 1),
  ys = (i) => {
    ...
    const g = `flex items-center gap-x-1 ${s ? "mt-1.5" : "mt-3"}`,
      u = s ? 16 : 18;
    let f;
    e[17] !== r || e[18] !== n || e[19] !== u
      ? ((f = (0, t.jsx)(q, {
          icon: xe,
          size: u,
          type: "like",
    ...
    e[28] !== d || e[29] !== s
      ? ((m =
          !s && d && (0, t.jsx)(q, { icon: ke, type: "share", onClick: d })),
        (e[28] = d),
        (e[29] = s),
        (e[30] = m))
      : (m = e[30]);
    let C;
    return (
      e[31] !== g || e[32] !== f || e[33] !== h || e[34] !== v || e[35] !== m
        ? ((C = (0, t.jsxs)("div", { className: g, children: [f, h, v, m] })),
          (e[31] = g),
          (e[32] = f),
          (e[33] = h),
          (e[34] = v),
  ...
  $s = (i) => {
    ...
    if (a === 0 && n === 0 && (s === 0 || b)) return null;
    const g = `mt-1 flex items-center gap-x-1.5 px-0.5 ${b ? "text-[12px]" : "text-[14px]"} font-medium text-zinc-500 dark:text-zinc-400`;
    let u;
    e[19] !== a || e[20] !== b || e[21] !== n || e[22] !== s
      ? ((u =
          s > 0 &&
          !b &&
          (0, t.jsxs)(t.Fragment, {
    ...
    e[24] !== a || e[25] !== c
      ? ((f =
          ...
          (0, t.jsxs)("button", {
            className: "hover:underline",
            onClick: (v) => {
              (v.stopPropagation(), c && c(v));
            },
            children: [a, " ", a === 1 ? "reply" : "replies"],
          })),
        (e[24] = a),
        (e[25] = c),
        (e[26] = f))
    ...
    let x;
    return (
      e[32] !== g || e[33] !== u || e[34] !== f || e[35] !== p || e[36] !== h
        ? ((x = (0, t.jsxs)("div", { className: g, children: [u, f, p, h] })),
          (e[32] = g),
          (e[33] = u),
          (e[34] = f),
          (e[35] = p),
  ...
  Ss = (i) => {
    ...
    e[0] !== r || e[1] !== s.handle
      ? ((f = (I) => {
          (I.stopPropagation(), r && r(s.handle));
        }),
        (e[0] = r),
        (e[1] = s.handle),
        (e[2] = f))
    ...
    e[3] !== a || e[4] !== u
      ? ((h = (I) => {
          (I.stopPropagation(), a && u(`/c/${a.handle}`));
        }),
        (e[3] = a),
        (e[4] = u),
        (e[5] = h))
      : (h = e[5]);
    const x = h,
      v = `flex items-center justify-between ${d ? "pb-4" : "min-h-[40px] mb-1"}`;
    let m;
    e[6] !== p ||
    e[7] !== c ||
    e[8] !== d ||
    ...
    e[11] !== s.handle
      ? ((m =
          ...
          (0, t.jsx)("button", {
            ...
            onClick: p,
            children: (0, t.jsxs)(Q, {
              className: `${d ? "size-12" : c ? "size-8" : "size-10"} border-0 shadow-sm`,
              children: [
                (0, t.jsx)(X, {
                  src: s.avatar,
                  alt: s.handle,
        ...
        (e[12] = m))
      : (m = e[12]);
    const C = `flex shrink-0 items-center gap-1 font-bold text-zinc-900 hover:underline dark:text-white ${d ? "text-base sm:text-lg" : c ? "text-[14px]" : "text-[15px]"}`;
    let y;
    e[13] !== s.handle
      ? ((y = (0, t.jsx)("span", {
      ...
      ? ((l =
          ...
          (0, t.jsxs)("div", {
            ...
            children: [
              ...
              (0, t.jsxs)("button", {
                className: `flex items-center gap-1 font-bold text-zinc-900 hover:underline dark:text-zinc-100 ${d ? "text-[14px] sm:text-[15px]" : "text-[13px]"}`,
                onClick: x,
                children: [
                  (0, t.jsxs)(Q, {
                    className:
    ...
    let T;
    return (
      e[39] !== S || e[40] !== k || e[41] !== v
        ? ((T = (0, t.jsxs)("div", { className: v, children: [S, k] })),
          (e[39] = S),
          (e[40] = k),
          (e[41] = v),
          (e[42] = T))
  ...
  Ps = (i) => {
    const e = (0, Fs.c)(45),
      ...
      u = ie(),
      [f, p] = (0, N.useState)(!1),
      h = typeof s == "string" && Ge(s);
    if (a && o) {
      let k;
      e[0] !== o
        ? ((k = (U) => o(U.target.value)), (e[0] = o), (e[1] = k))
        : (k = e[1]);
      const T = `min-h-[100px] w-full rounded-xl border-zinc-200 bg-zinc-50 focus:ring-violet-500 dark:border-zinc-800 dark:bg-zinc-900 ${Ge(r || "") ? "font-bangla text-lg" : "font-english"}`;
      let I;
      e[2] !== r || e[3] !== k || e[4] !== T
        ? ((I = (0, t.jsx)(ks, {
            value: r,
      ...
      e[8] !== s || e[9] !== r || e[10] !== b
        ? ((D = b || !r?.trim() || r === s),
          ...
          (e[11] = D))
        : (D = e[11]);
      const _ = b ? "Saving..." : "Save";
      let $;
      e[12] !== d || e[13] !== D || e[14] !== _
        ? (($ = (0, t.jsx)("button", {
            onClick: d,
            disabled: D,
            className:
    ...
    const x = !n && s.length > 280;
    let v;
    e[22] !== s || e[23] !== f || e[24] !== x
      ? ((v = x && !f ? s.substring(0, 280) : s),
        (e[22] = s),
        (e[23] = f),
        (e[24] = x),
        (e[25] = v))
    ...
    const m = v,
      ...
      y = h ? "font-bangla text-[1.15em]" : "font-english";
    let j;
    e[26] !== g || e[27] !== C || e[28] !== y
      ? ((j = V("whitespace-pre-line break-words", C, y, g)),
        (e[26] = g),
        (e[27] = C),
        (e[28] = y),
        (e[29] = j))
    ...
    e[30] !== u
      ? ((z = {
          ...$e,
          render: (k) => {
            const { attributes: T, content: I } = k,
              { href: A, ...D } = T,
              _ = window.location.origin;
            if (A.includes("internal.tag/")) {
              const R = decodeURIComponent(A.split("internal.tag/")[1]);
              return (0, t.jsxs)(
                "span",
                {
                  ...D,
    ...
    let w;
    e[34] !== z || e[35] !== l
      ? ((w = (0, t.jsx)(Ce, { options: z, children: l })),
        (e[34] = z),
        (e[35] = l),
        (e[36] = w))
      : (w = e[36]);
    ...
    let P;
    return (
      e[40] !== j || e[41] !== w || e[42] !== S || e[43] !== M
        ? ((P = (0, t.jsxs)("div", { className: j, children: [w, S, M] })),
          (e[40] = j),
          (e[41] = w),
          (e[42] = S),
          (e[43] = M),
...
var Rs = O(),
  Is = (i) => {
    ...
    let d;
    e[0] !== a
      ? ((d = a === void 0 ? [] : a), (e[0] = a), (e[1] = d))
      : (d = e[1]);
    const b = d;
    let g;
    e[2] !== o
      ? ((g = o === void 0 ? [] : o), (e[2] = o), (e[3] = g))
      : (g = e[3]);
    const u = g,
      f = (0, N.useRef)(null);
    if (n && r && c) {
      ...
      let v;
      e[14] !== b.length || e[15] !== u.length
        ? ((v =
            b.length + u.length < 4 &&
            (0, t.jsxs)("button", {
              onClick: (j) => {
                (j.stopPropagation(), f.current?.click());
              },
              className:
    ...
    return (
      e[26] !== s
        ? ((p = (0, t.jsx)(ai, { items: s })), (e[26] = s), (e[27] = p))
        : (p = e[27]),
      p
    );
  },
  ...
  As = (i) => {
    ...
    if (
      ...
      f = M[u] || M.default;
      const P = c || f.activeText;
      (e[11] !== r
        ? ((h = (k) => {
            (k.stopPropagation(), r && r(k));
          }),
          (e[11] = r),
          (e[12] = h))
        : (h = e[12]),
        ...
        (e[9] = x),
        (e[10] = v));
    } else ((f = e[6]), (p = e[7]), (h = e[8]), (x = e[9]), (v = e[10]));
    const m = o ? 2.5 : 2,
      C = o && f.activeFill;
    let y;
    e[13] !== C
      ? ((y = V("transition-colors duration-200", C)), (e[13] = C), (e[14] = y))
      : (y = e[14]);
    let j;
    e[15] !== s || e[16] !== g || e[17] !== m || e[18] !== y
      ? ((j = (0, t.jsx)(s, { size: g, strokeWidth: m, className: y })),
        (e[15] = s),
        (e[16] = g),
        (e[17] = m),
        (e[18] = y),
    ...
    let z;
    e[20] !== j || e[21] !== p
      ? ((z = (0, t.jsx)("div", { className: p, children: j })),
        (e[20] = j),
        (e[21] = p),
        (e[22] = z))
      : (z = e[22]);
    ...
    e[23] !== a
      ? ((l =
          a &&
          (0, t.jsx)("span", { className: "hidden xs:inline", children: a })),
        (e[23] = a),
        (e[24] = l))
      : (l = e[24]);
    let w;
    e[25] !== o || e[26] !== n
      ? ((w =
          n != null &&
          (0, t.jsx)("span", {
            className: V("transition-all", o ? "font-black" : "font-bold"),
            children: n || 0,
          })),
        (e[25] = o),
        (e[26] = n),
  ...
  Ls = (i) => {
    ...
    const d = c;
    let b;
    if (e[3] !== d || e[4] !== s.options || e[5] !== a || e[6] !== r) {
      let h;
      (e[8] !== d || e[9] !== a || e[10] !== r
        ? ((h = (x, v) => {
            const m =
            ...
            return (0, t.jsxs)(
              ...
              {
                onClick: () => d(x.id),
                className: `relative h-10 w-full overflow-hidden rounded-xl border cursor-pointer ${C ? "border-violet-500 dark:border-violet-500" : "border-zinc-200 dark:border-zinc-700"}`,
                children: [
                  r &&
                    (0, t.jsx)("div", {
                      className:
                  ...
                  (0, t.jsxs)("div", {
                    ...
                    children: [
                      (0, t.jsxs)("span", {
                        className: `text-sm font-medium ${C ? "font-bold text-violet-600" : "text-zinc-700 dark:text-zinc-200"}`,
                        children: [
                          x.text,
                          " ",
                          C &&
...
var Os = O(),
  Ws = (i) => {
    const e = (0, Os.c)(30),
      { user: s, time: n, content: a } = i,
      r = ie();
    let o;
    e[0] !== s.avatar || e[1] !== s.handle
      ? ((o = (0, t.jsx)(X, { src: s.avatar, alt: s.handle })),
        (e[0] = s.avatar),
        (e[1] = s.handle),
        (e[2] = o))
      : (o = e[2]);
    let c;
    e[3] !== s.handle[0]
      ? ((c = s.handle[0]?.toUpperCase()), (e[3] = s.handle[0]), (e[4] = c))
      : (c = e[4]);
    let d;
    e[5] !== c
      ? ((d = (0, t.jsx)(K, { children: c })), (e[5] = c), (e[6] = d))
      : (d = e[6]);
    let b;
    e[7] !== o || e[8] !== d
      ? ((b = (0, t.jsxs)(Q, { className: "size-6", children: [o, d] })),
        (e[7] = o),
        (e[8] = d),
        (e[9] = b))
      : (b = e[9]);
    ...
    e[20] !== r
      ? ((h = {
          ...$e,
          render: (C) => {
            const { attributes: y, content: j } = C,
              { href: z, ...l } = y,
    ...
    let v;
    e[24] !== x || e[25] !== h
      ? ((v = (0, t.jsx)(Ce, { options: h, children: x })),
        (e[24] = x),
        (e[25] = h),
        (e[26] = v))
      : (v = e[26]);
    ...
    return (
      e[27] !== v || e[28] !== p
        ? ((m = (0, t.jsxs)("div", { className: "p-4", children: [p, v] })),
          (e[27] = v),
          (e[28] = p),
          (e[29] = m))
        : (m = e[29]),
...
var Vs = O(),
  qs = (i) => {
    ...
    e[2] !== d
      ? ((p = (E) => {
          if (E.target.files) {
            const U = Array.from(E.target.files);
            d && d((B) => [...B, ...U]);
          }
        }),
        (e[2] = d),
    ...
    e[6] !== d
      ? ((m = (E) => {
          const U = E.clipboardData.files;
          if (U && U.length > 0) {
            const B = Array.from(U).filter(Hs);
            B.length > 0 && (E.preventDefault(), d && d((Z) => [...Z, ...B]));
          }
        }),
        (e[6] = d),
        (e[7] = m))
    ...
    let z;
    e[14] !== j
      ? ((z = (0, t.jsx)(K, { children: j })), (e[14] = j), (e[15] = z))
      : (z = e[15]);
    let l;
    e[16] !== y || e[17] !== z
      ? ((l = (0, t.jsxs)(Q, {
    ...
    let w;
    e[19] !== a
      ? ((w = (E) => a(E.target.value)), (e[19] = a), (e[20] = w))
      : (w = e[20]);
    let S;
    e[21] !== C || e[22] !== n || e[23] !== w
      ? ((S = (0, t.jsx)("textarea", {
          id: "comment-input",
          className:
    ...
    e[39] !== T || e[40] !== D
      ...
      : (_ = e[41]);
    let $;
    e[42] !== S || e[43] !== M || e[44] !== _
      ? (($ = (0, t.jsxs)("div", { className: "flex-1", children: [S, M, _] })),
        (e[42] = S),
        (e[43] = M),
        (e[44] = _),
        (e[45] = $))
...
var Gs = O(),
  Js = (i) => {
    ...
    let o;
    e[3] !== n || e[4] !== a || e[5] !== r
      ? ((o = { queryKey: n, queryFn: a, staleTime: 864e5, enabled: r }),
        (e[3] = n),
        (e[4] = a),
        (e[5] = r),
        (e[6] = o))
      : (o = e[6]);
    const { data: c, isLoading: d, isError: b } = Ft(o);
    if (d) {
      let y;
      return (
        e[7] === Symbol.for("react.memo_cache_sentinel")
    ...
    if (b || !c || (!c.title && !c.image)) return null;
    let g;
    e[8] !== c.image || e[9] !== c.title
      ? ((g =
          c.image &&
          (0, t.jsx)("div", {
            className:
    ...
    e[12] !== c.siteName
      ? ((f = (0, t.jsxs)("div", {
          ...
          children: [u, (0, t.jsx)("span", { children: c.siteName })],
        })),
        (e[12] = c.siteName),
        (e[13] = f))
      : (f = e[13]);
...
var ti = O(),
  si = N.lazy(() =>
    dt(
      () => import("./VideoPlayer-dv5xP0OK.js"),
  ...
  ii = (i) => {
    ...
    const r = Array.isArray(n) ? n : [n],
      ...
      c = r.filter(ni),
      d = (p) => {
        const h = o.filter(ri).map(oi),
          x = o[p];
        a(h, h.indexOf(x.url || x.src));
      },
      b = "mt-2 space-y-2",
      g =
        o.length > 0 &&
        (0, t.jsx)("div", {
          className: `grid gap-2 overflow-hidden rounded-2xl border border-zinc-100 dark:border-zinc-800 ${o.length === 1 ? "grid-cols-1" : o.length === 2 ? "aspect-[16/9] grid-cols-2" : (o.length === 3, "aspect-[16/9] grid-cols-2 grid-rows-2")}`,
          children: o.map((p, h) =>
            (0, t.jsx)(
              "div",
              {
                className: `relative cursor-pointer overflow-hidden bg-zinc-100 dark:bg-zinc-900 ${o.length === 3 && h === 0 ? "row-span-2" : ""}
                                `,
                onClick: (x) => {
                  p.type === "image" && (x.stopPropagation(), d(h));
                },
                children:
                  p.type === "video"
                    ? (0, t.jsx)(N.Suspense, {
                    ...
                    : (0, t.jsx)("img", {
                        src: p.url || p.src,
                        className:
                          "size-full object-cover transition-transform duration-500 hover:scale-[1.02]",
                        alt: "",
                        loading: "lazy",
                      }),
              },
    ...
    return (
      e[0] !== g || e[1] !== u
        ? ((f = (0, t.jsxs)("div", { className: b, children: [g, u] })),
          (e[0] = g),
          (e[1] = u),
          (e[2] = f))
        : (f = e[2]),
...
var di = O(),
  mi = (i) => {
    ...
    if (e[0] !== s) {
      const o = s.slice(0, 3);
      ((n = "relative mt-2 h-7 w-7"),
        (a = o.map((c, d) => {
          let b, g;
          return (
            o.length === 1
              ? ((b = "top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2"),
                (g = "size-5"))
              : o.length === 2
                ? ((g = "size-4"),
                  (b = d === 0 ? "top-0 right-0" : "bottom-0 left-0"))
                : ((g = d === 0 ? "size-3.5" : "size-3"),
                  d === 0
                    ? (b = "top-0 right-0")
                    : d === 1
                      ? (b = "bottom-0 right-0")
                      : (b = "top-1/2 left-0 -translate-y-1/2")),
            (0, t.jsx)(
              "div",
              {
                className: `absolute rounded-full border border-white bg-zinc-100 dark:border-black dark:bg-zinc-800 overflow-hidden shadow-sm ${b} ${g}`,
                style: { zIndex: 10 - d },
                children: (0, t.jsx)("img", {
                  src: c,
                  alt: "",
    ...
    return (
      e[3] !== n || e[4] !== a
        ? ((r = (0, t.jsx)("div", { className: n, children: a })),
          (e[3] = n),
          (e[4] = a),
          (e[5] = r))
        : (r = e[5]),
  ...
  we = ({
    ...
    const w = ie(),
      ...
      [he, fe] = (0, N.useState)(""),
      [ue, _e] = (0, N.useState)([]),
      [vt, Se] = (0, N.useState)(!1),
      [Fe, ae] = (0, N.useState)(!1),
      [le, Y] = (0, N.useState)(!1),
      [H, ne] = (0, N.useState)(n),
      [re, oe] = (0, N.useState)(r || []),
      [ce, ee] = (0, N.useState)([]),
      [Pe, Te] = (0, N.useState)(!1),
      [bt, pe] = (0, N.useState)(!1),
      [ge, de] = (0, N.useState)(null),
      [ve, Me] = (0, N.useState)(!1),
      {
        comments: jt,
        isLoading: zt,
        refetch: Re,
      } = et(z || i, [], ve ? i : void 0),
      { ref: Ie, inView: Ee } = _t({ threshold: 0.5, triggerOnce: !0 });
    (0, N.useEffect)(() => {
      if (Ee && !m) {
        const F = setTimeout(() => {
          ds(i).catch(console.error);
        }, 1500);
        return () => clearTimeout(F);
      }
    }, [Ee, i, m]);
    const kt = (0, N.useCallback)(async () => {
        !i || (!z && !i) || k.comments === 0 || (Me(!0), Re());
      }, [i, z, k.comments, Re]),
      Ae = async () => {
        const F =
          JSON.stringify(re) !== JSON.stringify(r || []) || ce.length > 0;
        if (!H.trim() || (H === n && !F)) {
          Y(!1);
          return;
        }
        ...
        try {
          ...
          const W = [...re, ...L];
          (m
            ? await bs(i, { content: H, media: W })
            : await _(i, { content: H, media: W }),
            ee([]),
            Y(!1),
            S(`${m ? "Comment" : "Post"} updated`),
            v && v(i, H, W));
        } catch (L) {
          (console.error(`Failed to update ${m ? "comment" : "post"}:`, L),
      ...
      De = async (F) => {
        F && F.stopPropagation();
        try {
          (m ? await ts(i) : await D(i),
            S(`${m ? "Comment" : "Post"} deleted successfully`),
            x && x(i));
        } catch (L) {
          (console.error(`Failed to delete ${m ? "comment" : "post"}:`, L),
      ...
      Nt = async (F) => {
        if ((F.preventDefault(), !((!he.trim() && ue.length === 0) || !u))) {
          Se(!0);
          try {
            const L = [];
            for (const W of ue) {
            ...
            (await Z({
              ...
              _e([]),
              de(null),
              T((W) => ({ ...W, comments: (W.comments || 0) + 1 })),
              S("Reply posted!"));
          } catch (L) {
            (console.error("Failed to post comment:", L),
                  ...
                  children: [
                    ...
                    !m &&
                      (0, t.jsxs)(te, {
                        className: "cursor-pointer gap-2 py-2.5",
                        onClick: (L) => {
                          (L.stopPropagation(), S("Post reported"));
                        },
                        children: [
                          (0, t.jsx)(Ut, { size: 16 }),
                    ...
                    !be &&
                      (0, t.jsxs)(te, {
                        className: "cursor-pointer gap-2 py-2.5",
                        onClick: (L) => {
                          (L.stopPropagation(), S("User blocked"));
                        },
                        children: [
                          (0, t.jsx)(Rt, { size: 16 }),
                          (0, t.jsxs)("span", {
                            children: ["Block @", e.handle],
                          }),
                        ],
                      }),
                    be &&
                      (0, t.jsxs)(te, {
                        onClick: (L) => {
                          (L.stopPropagation(), Y(!0));
                        },
                        className: "cursor-pointer gap-2 py-2.5",
                        children: [(0, t.jsx)(Jt, { size: 16 }), "Edit Post"],
                      }),
                  ],
                }),
                be &&
                    ...
                    children: [
                      ...
                      (0, t.jsx)(Ve, {
                        children: (0, t.jsxs)(te, {
                          ...
                          className: "cursor-pointer gap-2 py-2.5",
                          onClick: (L) => {
                            (L.stopPropagation(), ae(!0));
                          },
                          children: [
                            (0, t.jsx)(Yt, { size: 16 }),
                            (0, t.jsx)("span", { children: "Delete post" }),
                          ],
                        }),
                      }),
                    ],
      ...
      be = u?.handle === e.handle,
      wt = (F, L) => {
        (de(L ? { handle: F, id: m ? j || i : L } : null),
          fe((W) => {
            const J = `@${F} `;
            return W.includes(J) ? W : J + W;
          }),
    ...
    return p
      ? (0, t.jsxs)("div", {
          ...
          children: [
            ...
            (0, t.jsx)(Ke, {
              open: Fe,
              onOpenChange: ae,
              children: (0, t.jsxs)(Xe, {
                onClick: (F) => F.stopPropagation(),
                children: [
                  (0, t.jsxs)(Je, {
                    children: [
                      (0, t.jsx)(Qe, { children: "Are you absolutely sure?" }),
                      (0, t.jsx)(Ye, {
                        children:
      ...
      : (0, t.jsxs)("article", {
          ref: Ie,
          onClick: d,
          className: `px-4 transition-all ${m ? "py-2 bg-transparent hover:bg-zinc-50/30 dark:hover:bg-zinc-800/20" : "py-4 border-b border-zinc-100 bg-white hover:bg-zinc-50/30 dark:border-zinc-800 dark:bg-black dark:hover:bg-white/[0.02]"} ${d ? "cursor-pointer" : ""}`,
          children: [
            b &&
              (0, t.jsxs)("div", {
                className:
                ...
                children: [
                  ...
                  (0, t.jsxs)("span", {
                    ...
                    onClick: (F) => {
                      (F.stopPropagation(), g && g(b.handle));
                    },
                    children: [b.handle, " Reposted"],
                  }),
                ],
              }),
            (0, t.jsxs)("div", {
                ...
                (0, t.jsxs)("div", {
                  ...
                  children: [
                    (0, t.jsx)("div", {
                      ...
                      onClick: (F) => {
                        (F.stopPropagation(), g && g(e.handle));
                      },
                      children: (0, t.jsxs)(Q, {
                    ...
                    ((!m && k.comments > 0) || (m && !j && k.comments > 0)) &&
                      (0, t.jsxs)(t.Fragment, {
                        children: [
                          (0, t.jsx)("div", {
                            className:
                  ...
                  children: [
                    ...
                    (0, t.jsx)(tt, {
                      ...
                      handleCommentClick: (F) => {
                        (F?.stopPropagation(), C ? C(e.handle, i) : d && d());
                      },
                      handleShareClick: (F) => {
...
function xi(i, e) {
  const s =
      ...
      (i.media?.length === e.media?.length &&
        i.media?.every((a, r) => a.url === e.media?.[r].url)),
    n = i.repostedBy?.handle === e.repostedBy?.handle;
  return (
    i.id === e.id &&
    i.content === e.content &&
    i.timeAgo === e.timeAgo &&
...
var hi = N.memo(we, xi),
  fi = ({ isOpen: i, onClose: e, url: s, title: n = "Share" }) => {
      ...
      v = (0, N.useCallback)(async () => {
        if (x) {
          ...
          try {
            ...
            console.error("Failed to fetch conversations:", l);
          } finally {
            u(!1);
          }
        }
          ...
          b(
            (await Be(x.id))
              ...
              .filter(
                (l) =>
                  l !== null &&
                  (l.name?.toLowerCase().includes(o.toLowerCase()) ||
                    l.handle.toLowerCase().includes(o.toLowerCase())),
              ),
          );
        } catch (l) {
          console.error("Search failed:", l);
        } finally {
          u(!1);
        }
      }
    ...
    const C = async (l) => {
      ...
      y = async (l) => {
        if (x) {
          p(l.id);
          try {
            (await es(await ls(x.id, l.id), x.id, s, "text"),
              h(`Sent to ${l.name || l.handle}!`, "success"));
          } catch (w) {
      ...
      z = async () => {
        if (navigator.share)
          try {
            await navigator.share({ title: n, url: s });
          } catch (l) {
            l.name !== "AbortError" && console.error("Native share failed:", l);
          }
        else C();
      };
    return (0, t.jsx)(xt, {
                      ...
                      "button",
                      {
                        ...
                        children: [
                            ...
                            children: [
                              (0, t.jsx)("div", {
                                ...
                                children: (0, t.jsx)("img", {
                                  src:
                                    l.avatar ||
                                    `https://i.pravatar.cc/150?u=${l.id}`,
                                  alt: l.handle,
                                  className: "size-full object-cover",
                                }),
                              }),
                          ...
                          (0, t.jsx)("span", {
                            ...
                            children: l.name?.split(" ")[0] || l.handle,
                          }),
                        ],
                      },
                      l.id,
              ...
              j.map((l) =>
                (0, t.jsxs)(
                  "a",
                  {
                    ...
                    children: [
                      (0, t.jsx)("div", {
                        className: `size-12 ${l.color} flex items-center justify-center rounded-2xl shadow-md transition-all group-hover:-translate-y-1 group-hover:scale-110 group-hover:shadow-lg`,
              ...
              (0, t.jsxs)("button", {
                ...
                children: [
                  (0, t.jsx)("div", {
                    ...
                    children: (0, t.jsx)(ze, { size: 20, strokeWidth: 2.5 }),
                  }),
                  (0, t.jsx)("span", {
                    className:
                      "text-[10px] font-bold uppercase tracking-tighter text-zinc-500 dark:text-zinc-400",
          ...
          (0, t.jsx)("div", {
            ...
            children: (0, t.jsxs)("div", {
              ...
              children: [
                ...
                (0, t.jsx)("button", {
                  onClick: C,
                  className: `absolute right-1.5 top-1/2 flex -translate-y-1/2 items-center gap-2 rounded-xl h-10 px-4 text-xs font-bold shadow-sm transition-all active:scale-95 ${a ? "bg-emerald-500 text-white" : "bg-zinc-900 text-white hover:opacity-90 dark:bg-white dark:text-zinc-900"}`,
                  children: a
                    ? (0, t.jsxs)(t.Fragment, {
                        children: [
                          (0, t.jsx)(Mt, { size: 14, strokeWidth: 3 }),
                          (0, t.jsx)("span", { children: "Copied" }),
                        ],
                      })
                    : (0, t.jsxs)(t.Fragment, {
                        children: [
                          (0, t.jsx)(Et, { size: 14, strokeWidth: 3 }),
  ...
  pi = N.memo(
    ({ reel: i, isActive: e, isMuted: s }) => {
      const n = ie(),
        ...
        [x, v] = (0, N.useState)(!1),
        [m, C] = (0, N.useState)(i.stats?.likes || 0),
        [y, j] = (0, N.useState)(!1),
        [z, l] = (0, N.useState)(0),
        w = (0, N.useRef)(null),
        S = (0, N.useMemo)(
        ...
        (0, N.useEffect)(() => {
          ...
          (async () => {
            try {
              ...
              console.error("Failed to check interaction status:", $);
            }
          })();
        }, [i.id, a?.id, e, i.user?.id]),
        (0, N.useEffect)(() => {
          const _ = o.current?.plyr;
          _ && (_.muted = s);
        }, [s]),
        (0, N.useEffect)(() => {
          const _ = o.current?.plyr;
          ...
          if (typeof _.on == "function")
            return (
              _.on("timeupdate", $),
              () => {
                typeof _.off == "function" && _.off("timeupdate", $);
              }
            );
        }, [e]),
        (0, N.useEffect)(
      ...
      const M = (_) => {
          ...
          $.closest("button") ||
            $.closest("a") ||
            $.closest(".plyr__controls") ||
            (w.current
              ? (clearTimeout(w.current), (w.current = null), k())
        ...
        P = () => {
          ...
          _ &&
            (_.paused
              ? (_.play().catch(() => {}), h("play"))
              : (_.pause(), h("pause")),
            setTimeout(() => h(null), 800));
        },
        k = async () => {
          if (a && (d(!0), setTimeout(() => d(!1), 1e3), !x)) {
            (v(!0), C((_) => _ + 1));
            try {
              await We(i.id, a.id);
            } catch {
        ...
        I = async (_) => {
          ...
          j($);
          try {
            await vs(a.id, i.user?.id);
          } catch {
            j(!$);
          }
        },
        A = (_) => {
          (_.stopPropagation(), f(!0));
        },
        D = (0, N.useMemo)(
          () => ({
            source: { type: "video", sources: [{ src: S, type: "video/mp4" }] },
            options: {
              controls: [],
              loop: { active: !0 },
              clickToPlay: !1,
                ...
                children: [
                  (0, t.jsxs)("div", {
                    ...
                    children: [
                      ...
                      a?.id !== i.user?.id &&
                        (0, t.jsx)("button", {
                          className: `ml-2 flex items-center gap-1.5 rounded-full px-3 py-1.5 text-xs font-bold transition-all active:scale-95 ${y ? "border border-white/50 bg-transparent text-white" : "bg-white text-black hover:bg-zinc-200"}`,
                          onClick: I,
                          children: y
                            ? (0, t.jsxs)(t.Fragment, {
                                children: [
              ...
              (0, t.jsxs)("div", {
                ...
                children: [
                  (0, t.jsxs)("div", {
                    ...
                    children: [
                      (0, t.jsx)("button", {
                        className: `rounded-full p-3 backdrop-blur-md transition-all active:scale-90 ${x ? "bg-rose-500/20 text-rose-500" : "bg-zinc-800/50 text-white hover:bg-zinc-700"}`,
                        onClick: T,
                        children: (0, t.jsx)(xe, {
                          size: 28,
                  ...
                  (0, t.jsxs)("div", {
                    ...
                    children: [
                      (0, t.jsx)("button", {
                        ...
                        onClick: (_) => {
                          (_.stopPropagation(), g(!0));
                        },
                        children: (0, t.jsx)(ht, { size: 28 }),
                      }),
                      (0, t.jsx)("span", {
                        className: "text-xs font-bold text-white",
  ...
  $i = pi,
  gi = ({ isOpen: i, onClose: e, reelId: s, currentUser: n, showToast: a }) => {
        ...
        if (s) {
          ...
          try {
            const k = w.current,
              T = await as(
                s,
                P && k.length > 0 ? k[k.length - 1].created_at : null,
                10,
              );
            (T.length < 10 ? C(!1) : C(!0), o(P ? (I) => [...I, ...T] : T));
          } catch (k) {
            (console.error("Failed to load comments:", k),
              a && a("Failed to load comments", "error"));
          } finally {
            (d(!1), j(!1));
          }
        }
    ...
    const M = async (P) => {
      if ((P.preventDefault(), !((!u.trim() && p.length === 0) || !n))) {
        (g(!0), v(!0));
        try {
          const k = [];
          for (const T of p) {
          ...
          (console.error("Failed to post comment:", k),
            a && a("Failed to post reply.", "error"));
        } finally {
          (g(!1), v(!1));
        }
      }
                      ...
                      r.map((P) =>
                        (0, t.jsx)(
                          hi,
                          {
                            ...
                            showToast: a,
                            onReply: (k, T) => {
                              (l(T ? { handle: k, id: T } : null),
                                f((I) =>
                                  I.includes(`@${k}`) ? I : I + `@${k} `,
                                ));
                            },
                            onDelete: (k) =>
                              o((T) => T.filter((I) => I.id !== k)),
                            onUpdate: (k, T, I) =>
                              o((A) =>
                                A.map((D) =>
                                  D.id === k
