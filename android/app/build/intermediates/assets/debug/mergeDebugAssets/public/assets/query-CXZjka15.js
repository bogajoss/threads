import { a as ht } from "./rolldown-runtime-BaZ8gS7u.js";
import { o as Rt, s as Ct } from "./animations-pEILWrFP.js";
var x = class {
    constructor() {
...
function tt(t, e) {
  ...
  if (o) {
    if (i) {
      if (e.queryHash !== W(o, e.options)) return !1;
...
function et(t, e) {
  ...
  if (a) {
    ...
    } else if (!D(e.options.mutationKey, a)) return !1;
  }
...
function lt(t, e, s = 0) {
  ...
  if (s > 500) return e;
  const i = st(t) && st(e);
  if (!i && !(L(t) && L(e))) return e;
  const r = (i ? t : Object.keys(t)).length,
    a = i ? e : Object.keys(e),
    o = a.length,
    n = i ? new Array(o) : {};
  let h = 0;
  ...
  return (
    Object.defineProperty(t, "signal", {
      ...
      get: () => (
        ...
        i ||
          ((i = !0),
          r.aborted ? s() : r.addEventListener("abort", s, { once: !0 })),
        r
      ),
    }),
    t
  ...
  const r = H(),
    ...
    f = () => {
      ...
      Promise.resolve(d)
        ...
        .catch((P) => {
          if (a()) return;
          const R = t.retry ?? (Q ? 0 : 3),
            C = t.retryDelay ?? _t,
            E = typeof C == "function" ? C(s, P) : C,
            O =
              R === !0 ||
              (typeof R == "number" && s < R) ||
              (typeof R == "function" && R(s, P));
          if (e || !O) {
            p(P);
            return;
          }
...
var yt = class {
    ...
    updateGcTime(t) {
      this.gcTime = Math.max(this.gcTime || 0, t ?? (Q ? 1 / 0 : 300 * 1e3));
    }
    clearGcTimeout() {
  ...
  Kt = class extends yt {
    ...
    setOptions(t) {
      if (
        ...
        e.data !== void 0 &&
          (this.setState(rt(e.data, e.dataUpdatedAt)), (this.#t = e));
      }
    }
    optionalRemove() {
    ...
    setData(t, e) {
      const s = N(this.state.data, t, this.options);
      return (
        this.#n({
          data: s,
          type: "success",
    ...
    cancel(t) {
      ...
      return (this.#i?.cancel(t), e ? e.then(g).catch(g) : Promise.resolve());
    }
    destroy() {
    ...
    isActive() {
      return this.observers.some((t) => S(t.options.enabled, this) !== !1);
    }
    isDisabled() {
    ...
    async fetch(t, e) {
      ...
      const s = new AbortController(),
        ...
        r = () => {
          ...
          return (
            (this.#o = !1),
            this.options.persister ? this.options.persister(n, u, this) : n(u)
          );
        },
        o = (() => {
          const n = {
      ...
      (this.options.behavior?.onFetch(o, this),
        ...
        (this.state.fetchStatus === "idle" ||
          ...
          this.#n({ type: "fetch", meta: o.fetchOptions?.meta }),
        (this.#i = pt({
...
var mt = class extends x {
  ...
  onSubscribe() {
    this.listeners.size === 1 &&
      ...
      at(this.#e, this.options) ? this.#l() : this.updateResult(),
      this.#b());
  }
  onUnsubscribe() {
  ...
  shouldFetchOnReconnect() {
    return B(this.#e, this.options, this.options.refetchOnReconnect);
  }
  shouldFetchOnWindowFocus() {
    return B(this.#e, this.options, this.options.refetchOnWindowFocus);
  }
  destroy() {
    ((this.listeners = new Set()),
      this.#O(),
  ...
  setOptions(t) {
    ...
    if (
      ...
      this.options.enabled !== void 0 &&
        ...
        typeof S(this.options.enabled, this.#e) != "boolean")
    )
      throw new Error(
    ...
    (i && ot(this.#e, s, this.options, e) && this.#l(),
      ...
      i &&
        (this.#e !== s ||
          S(this.options.enabled, this.#e) !== S(e.enabled, this.#e) ||
  ...
  getOptimisticResult(t) {
    ...
    return (
      Nt(this, s) &&
        ((this.#r = s), (this.#a = this.options), (this.#i = this.#e.state)),
      s
    );
  }
  getCurrentResult() {
  ...
  #l(t) {
    ...
    return (t?.throwOnError || (e = e.catch(g)), e);
  }
  #v() {
    this.#O();
    const t = F(this.options.staleTime, this.#e);
    if (Q || this.#r.isStale || !K(t)) return;
    const e = ct(this.#r.dataUpdatedAt, t) + 1;
    this.#h = M.setTimeout(() => {
  ...
  #g(t) {
    (this.#P(),
      ...
      !(
        Q ||
        S(this.options.enabled, this.#e) === !1 ||
        !K(this.#u) ||
        this.#u === 0
      ) &&
        (this.#c = M.setInterval(() => {
          (this.options.refetchIntervalInBackground || J.isFocused()) &&
            this.#l();
        }, this.#u)));
  }
  #b() {
  ...
  #O() {
    this.#h && (M.clearTimeout(this.#h), (this.#h = void 0));
  }
  #P() {
    this.#c && (M.clearInterval(this.#c), (this.#c = void 0));
  }
  createResult(t, e) {
    const s = this.#e,
      i = this.options,
    ...
    if (e._optimisticResults) {
      const w = this.hasListeners(),
        I = !w && at(t, e),
        A = w && ot(t, s, e, i);
      ((I || A) && (u = { ...u, ...vt(h.data, t.options) }),
        e._optimisticResults === "isRestoring" && (u.fetchStatus = "idle"));
    }
    let { error: p, errorUpdatedAt: b, status: f } = u;
    c = u.data;
    let d = !1;
      ...
      (r?.isPlaceholderData && e.placeholderData === o?.placeholderData
        ...
        : (w =
            typeof e.placeholderData == "function"
              ...
              : e.placeholderData),
        w !== void 0 && ((f = "success"), (c = N(r?.data, w, e)), (l = !0)));
    }
    if (e.select && c !== void 0 && !d)
      if (r && c === a?.data && e.select === this.#y) c = this.#f;
      else
        try {
          ((this.#y = e.select),
            (c = e.select(c)),
    ...
    this.#n && ((p = this.#n), (c = this.#f), (b = Date.now()), (f = "error"));
    const m = u.fetchStatus === "fetching",
      ...
      O = {
        ...
        isFetchedAfterMount:
          u.dataUpdateCount > n.dataUpdateCount ||
          u.errorUpdateCount > n.errorUpdateCount,
        isFetching: m,
        isRefetching: m && !P,
        isLoadingError: R && !E,
    ...
    if (this.options.experimental_prefetchInRender) {
      const w = O.data !== void 0,
        I = O.status === "error" && !w,
        A = (Y) => {
          I ? Y.reject(O.error) : w && Y.resolve(O.data);
        },
        X = () => {
          A((this.#o = O.promise = H()));
        },
        j = this.#o;
      switch (j.status) {
        case "pending":
          t.queryHash === s.queryHash && A(j);
          break;
        case "fulfilled":
          (I || O.data !== j.value) && X();
          break;
        case "rejected":
          (!I || O.error !== j.reason) && X();
          break;
      }
    }
    return O;
...
function at(t, e) {
  return Lt(t, e) || (t.state.data !== void 0 && B(t, e, e.refetchOnMount));
}
function B(t, e, s) {
  if (S(e.enabled, t) !== !1 && F(e.staleTime, t) !== "static") {
    const i = typeof s == "function" ? s(t) : s;
    return i === "always" || (i !== !1 && Z(t, e));
  }
  return !1;
}
function ot(t, e, s, i) {
    ...
    onFetch: (e, s) => {
      ...
      const u = async () => {
        ...
        const c = (f) => {
          ...
          p = ft(e.options, e.fetchOptions),
          b = async (f, d, m) => {
            if (l) return Promise.reject();
            if (d == null && f.pages.length) return Promise.resolve(f);
            const R = await p(
                (() => {
                  const O = {
                    client: e.client,
        ...
        if (r && a.length) {
          ...
          const f = t ?? a.length;
          do {
            const d = h === 0 ? (o[0] ?? i.initialPageParam) : z(i, n);
            if (h > 0 && d == null) break;
            ((n = await b(n, d)), h++);
          } while (h < f);
        }
...
function Gt(t, e) {
  return !e || !t.getPreviousPageParam ? !1 : gt(t, e) != null;
}
var Bt = class extends mt {
    ...
    createResult(t, e) {
      const { state: s } = t,
        ...
        { isFetching: r, isRefetching: a, isError: o, isRefetchError: n } = i,
...
var Wt = class extends x {
  ...
  canRun(t) {
    const e = U(t);
    if (typeof e == "string") {
      const s = this.#e.get(e)?.find((i) => i.state.status === "pending");
      return !s || s === t;
    } else return !0;
  }
  runNext(t) {
  ...
  resumePausedMutations() {
    ...
    return y.batch(() => Promise.all(t.map((e) => e.continue().catch(g))));
  }
};
function U(t) {
...
var Vt = class extends x {
  ...
  he = class {
    ...
    #n;
    constructor(t = {}) {
      ((this.#t = t.queryCache || new $t()),
        (this.#e = t.mutationCache || new Wt()),
    ...
    ensureQueryData(t) {
      ...
      return i === void 0
        ? this.fetchQuery(t)
        : (t.revalidateIfStale &&
            s.isStaleByTime(F(e.staleTime, s)) &&
            this.prefetchQuery(e),
          Promise.resolve(i));
    }
    getQueriesData(t) {
      return this.#t.findAll(t).map(({ queryKey: e, state: s }) => [e, s.data]);
    }
    setQueryData(t, e, s) {
    ...
    cancelQueries(t, e = {}) {
      const s = { revert: !0, ...e },
        i = y.batch(() => this.#t.findAll(t).map((r) => r.cancel(s)));
    ...
    fetchQuery(t) {
      ...
      return s.isStaleByTime(F(e.staleTime, s))
        ? s.fetch(e)
        : Promise.resolve(s.state.data);
    }
    prefetchQuery(t) {
      return this.fetchQuery(t).then(g).catch(g);
    }
    fetchInfiniteQuery(t) {
      return ((t.behavior = _(t.pages)), this.fetchQuery(t));
    }
    prefetchInfiniteQuery(t) {
      return this.fetchInfiniteQuery(t).then(g).catch(g);
    }
    ensureInfiniteQueryData(t) {
      return ((t.behavior = _(t.pages)), this.ensureQueryData(t));
    }
    resumePausedMutations() {
    ...
    getQueryDefaults(t) {
      ...
      return (
        e.forEach((i) => {
          D(t, i.queryKey) && Object.assign(s, i.defaultOptions);
        }),
        s
      );
    }
    ...
    getMutationDefaults(t) {
      ...
      return (
        e.forEach((i) => {
          D(t, i.mutationKey) && Object.assign(s, i.defaultOptions);
        }),
        s
      );
    }
    defaultQueryOptions(t) {
      ...
      return (
        e.queryHash || (e.queryHash = W(e.queryKey, e)),
  ...
  ce = ({ client: t, children: e }) => (
    ...
    (0, Jt.jsx)(Ot.Provider, { value: t, children: e })
  ),
  wt = v.createContext(!1),
  Zt = () => v.useContext(wt),
  le = wt.Provider;
function Xt() {
  let t = !1;
...
var Yt = v.createContext(Xt()),
  te = () => v.useContext(Yt),
  ee = (t, e, s) => {
    const i =
      s?.state.error && typeof t.throwOnError == "function"
        ? $(t.throwOnError, [s.state.error, s])
        : t.throwOnError;
  ...
  ne = (t, e) => t.isLoading && t.isFetching && !e,
  ae = (t, e) => t?.suspense && e.isPending,
  ut = (t, e, s) =>
...
function St(t, e, s) {
  ...
  const h = !a.getQueryCache().get(o.queryHash),
    [u] = v.useState(() => new e(a, o)),
    l = u.getOptimisticResult(o),
    c = !i && t.subscribed !== !1;
  if (
    (v.useSyncExternalStore(
      v.useCallback(
        (p) => {
          const b = c ? u.subscribe(y.batchCalls(p)) : g;
  ...
  return (
    ...
    o.experimental_prefetchInRender &&
      !Q &&
      ne(l, i) &&
      (h ? ut(o, u, r) : n?.promise)?.catch(g).finally(() => {
        u.updateResult();
      }),
...
function de(t, e) {
  const s = Pt(e),
    [i] = v.useState(() => new Vt(s, t));
  v.useEffect(() => {
    i.setOptions(t);
  }, [i, t]);
  const r = v.useSyncExternalStore(
      v.useCallback((o) => i.subscribe(y.batchCalls(o)), [i]),
      () => i.getCurrentResult(),
      () => i.getCurrentResult(),
    ),
    a = v.useCallback(
      (o, n) => {
        i.mutate(o, n).catch(g);
      },
      [i],
    );
  if (r.error && $(i.options.throwOnError, [r.error])) throw r.error;
  return { ...r, mutate: a, mutateAsync: r.mutate };
}
function pe(t, e) {
  return St(t, Bt, e);
}
export { Pt as a, ce as i, de as n, he as o, fe as r, pe as t };
