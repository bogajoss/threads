import { a as Tt } from "./rolldown-runtime-BaZ8gS7u.js";
import { s as bt } from "./animations-pEILWrFP.js";
var At =
...
b.prototype = {
  ...
  tr(e, n, t, r) {
    ...
    let i;
    return (
      n && n.j ? (i = n) : ((i = new b(n)), t && r && D(n, t, r)),
      this.jr.push([e, i]),
      i
    );
  },
  ts(e, n, t, r) {
    ...
    const o = e.length;
    if (!o) return i;
    for (let s = 0; s < o - 1; s++) i = i.tt(e[s]);
    return i.tt(e[o - 1], n, t, r);
  },
  tt(e, n, t, r) {
    r = r || b.groups;
    const i = this;
    ...
    return (
      ...
      o &&
        (r &&
          (s.t && typeof s.t == "string"
            ? D(o, Object.assign(St(s.t, r), t), r)
            : t && D(o, t, r)),
        (s.t = o)),
      (i.j[e] = s),
      s
...
var c = (e, n, t, r, i) => e.ta(n, t, r, i),
  g = (e, n, t, r, i) => e.tr(n, t, r, i),
  rt = (e, n, t, r, i) => e.ts(n, t, r, i),
  a = (e, n, t, r, i) => e.tt(n, t, r, i),
  w = "WORD",
  Ke = "UWORD",
  ht = "ASCIINUMERICAL",
  dt = "ALPHANUMERICAL",
  ...
  oe = "FULLWIDTHLEFTPAREN",
  le = "FULLWIDTHRIGHTPAREN",
  ce = "LEFTCORNERBRACKET",
  ue = "RIGHTCORNERBRACKET",
  he = "LEFTWHITECORNERBRACKET",
  de = "RIGHTWHITECORNERBRACKET",
  fe = "FULLWIDTHLESSTHAN",
  ge = "FULLWIDTHGREATERTHAN",
  me = "AMPERSAND",
  ve = "APOSTROPHE",
  Ee = "ASTERISK",
  H = "AT",
  ...
  mt = Object.freeze({
    ...
    EQUALS: be,
    EXCLAMATION: Ye,
    FULLWIDTHGREATERTHAN: ge,
    FULLWIDTHLEFTPAREN: oe,
    FULLWIDTHLESSTHAN: fe,
    FULLWIDTHMIDDLEDOT: ft,
    FULLWIDTHRIGHTPAREN: le,
    HYPHEN: L,
    LEFTCORNERBRACKET: ce,
    LEFTWHITECORNERBRACKET: he,
    LOCALHOST: q,
    NL: qe,
    NUM: Ge,
    OPENANGLEBRACKET: ae,
    ...
    QUERY: Q,
    QUOTE: Ve,
    RIGHTCORNERBRACKET: ue,
    RIGHTWHITECORNERBRACKET: de,
    SCHEME: ee,
    SEMI: Xe,
    SLASH: O,
    SLASH_SCHEME: U,
...
function Nt(e = []) {
  ...
  (V == null && (V = at(At)),
    ...
    a(t, "\\", pe),
    a(t, "・", ft));
  const r = g(t, S, Ge, { [ze]: !0 });
  g(r, S, r);
  const i = g(r, C, ht, { [_]: !0 }),
    o = g(r, B, dt, { [F]: !0 }),
    s = g(t, C, w, { [Be]: !0 });
  (g(s, S, i), g(s, C, s), g(i, S, i), g(i, C, i));
  const l = g(t, B, Ke, { [Fe]: !0 });
  (g(l, C), g(l, S, o), g(l, B, l), g(o, S, o), g(o, C), g(o, B, o));
  const u = a(t, Pe, qe, { [He]: !0 }),
    d = a(t, it, Qe, { [He]: !0 }),
    f = g(t, De, Qe, { [He]: !0 });
  (a(t, Ue, f),
    a(d, Pe, u),
    ...
    g(f, De, f),
    a(f, Ue, f));
  const h = g(t, xe, gt, { [ut]: !0 });
  (a(h, "#"), g(h, xe, h), a(h, wt, h));
  const E = a(h, It);
  (a(E, "#"), g(E, xe, h));
  const p = [
      [C, s],
  ...
  for (let m = 0; m < V.length; m++) j(t, V[m], We, w, p);
  for (let m = 0; m < X.length; m++) j(t, X[m], $e, Ke, N);
  (D(We, { tld: !0, ascii: !0 }, n),
    D($e, { utld: !0, alpha: !0 }, n),
    j(t, "file", ee, w, p),
    j(t, "mailto", ee, w, p),
    j(t, "http", U, w, p),
    j(t, "https", U, w, p),
    j(t, "ftp", U, w, p),
    j(t, "ftps", U, w, p),
    D(ee, { scheme: !0, ascii: !0 }, n),
    D(U, { slashscheme: !0, ascii: !0 }, n),
    (e = e.sort((m, T) => (m[0] > T[0] ? 1 : -1))));
  ...
  return (
    rt(t, "localhost", q, { ascii: !0 }),
    (t.jd = new b(Ce)),
    { start: t, tokens: Object.assign({ groups: n }, mt) }
  );
}
function vt(e, n) {
  const t = jt(n.replace(/[A-Z]/g, (l) => l.toLowerCase())),
    r = t.length,
    i = [];
  let o = 0,
    s = 0;
  for (; s < r; ) {
    ...
    ((o -= h),
      (s -= E),
      (d -= h),
      i.push({ t: f.t, v: n.slice(o - d, o), s: o - d, e: o }));
  }
  return i;
}
function jt(e) {
...
function j(e, n, t, r, i) {
  ...
  for (let l = 0; l < s - 1; l++) {
    const u = n[l];
    (e.j[u] ? (o = e.j[u]) : ((o = new b(r)), (o.jr = i.slice()), (e.j[u] = o)),
      (e = o));
  }
  return ((o = new b(t)), (o.jr = i.slice()), (e.j[n[s - 1]] = o), o);
}
function at(e) {
  const n = [],
    t = [];
  ...
  for (; r < e.length; ) {
    let o = 0;
    for (; i.indexOf(e[r + o]) >= 0; ) o++;
    if (o > 0) {
      n.push(t.join(""));
      for (let s = parseInt(e.substring(r, r + o), 10); s > 0; s--) t.pop();
      r += o;
    } else (t.push(e[r]), r++);
  }
  return n;
...
function Ze(e, n = null) {
  let t = Object.assign({}, J);
  e && (t = Object.assign(t, e instanceof Ze ? e.o : e));
...
Et.prototype = {
  ...
  render(e) {
    const n = this,
      ...
      s = {},
      l = e.get("className", t, n),
      u = e.get("target", t, n),
      d = e.get("rel", t, n),
      f = e.getObj("attributes", t, n),
      h = e.getObj("events", t, n);
    return (
      (s.href = r),
      l && (s.class = l),
      u && (s.target = u),
...
var ot = Se("email", {
  ...
  Z = Se("url", {
    isLink: !0,
    toHref(e = J.defaultProtocol) {
      return this.hasProtocol() ? this.v : `${e}://${this.v}`;
    },
    hasProtocol() {
      const e = this.tk;
      return e.length >= 2 && e[0].t !== q && e[1].t === x;
    },
  }),
  A = (e) => new b(e);
function xt({ groups: e }) {
  ...
  (c(i, e.domain, s),
    ...
    c(s, e.domain, s));
  const d = a(s, H);
  (a(o, H, d), a(l, H, d), a(u, H, d));
  const f = a(o, R);
  (c(f, r, o), c(f, e.domain, o));
  const h = A();
  (c(d, e.domain, h), c(h, e.domain, h));
  const E = a(h, R);
  c(E, e.domain, h);
  const p = A(ot);
  (c(E, e.tld, p), c(E, e.utld, p), a(d, q, p));
  const N = a(h, L);
  (a(N, L, N),
    c(N, e.domain, h),
    c(p, e.domain, h),
    a(p, R, E),
    a(p, L, N),
    c(a(p, x), e.numeric, ot));
  const m = a(s, L),
    T = a(s, R);
  (a(m, L, m), c(m, e.domain, s), c(T, r, o), c(T, e.domain, s));
  const y = A(Z);
  (c(T, e.tld, y),
    c(T, e.utld, y),
    c(y, e.domain, s),
  ...
  const k = A(Z),
    M = A();
  (c(k, n, k), c(k, t, M), c(M, n, k), c(M, t, M), a(y, O, k), a(et, O, k));
  const we = a(l, x),
    Ie = a(a(a(u, x), O), O);
  (c(l, e.domain, s),
    a(l, R, T),
  ...
  return (a(i, q, y), a(i, qe, Ht), { start: i, tokens: mt });
}
function Dt(e, n, t) {
  let r = t.length,
    i = 0,
  ...
  for (; i < r; ) {
    let l = e,
      ...
      h = null,
      E = -1;
    for (; i < r && !(u = l.go(t[i].t)); ) s.push(t[i++]);
    for (; i < r && (d = u || l.go(t[i].t)); )
      ((u = null),
        (l = d),
        l.accepts() ? ((E = 0), (h = l)) : E >= 0 && E++,
        i++,
        f++);
    if (E < 0) ((i -= f), i < r && (s.push(t[i]), i++));
    else {
      (s.length > 0 && (o.push(Me(lt, n, s)), (s = [])), (i -= E), (f -= E));
      const p = h.t,
        N = t.slice(i - f, i);
      o.push(Me(p, n, N));
    }
  }
  return (s.length > 0 && o.push(Me(lt, n, s)), o);
}
function Me(e, n, t) {
  const r = t[0].s,
    i = t[t.length - 1].e;
  return new e(n.slice(r, i), t);
}
var ct = (typeof console < "u" && console && console.warn) || (() => {}),
  Pt =
...
function Ft(e, n) {
  if (typeof n != "function")
    throw new Error(`linkifyjs: Invalid plugin ${n} (expects function)`);
  for (let t = 0; t < v.pluginQueue.length; t++)
    if (e === v.pluginQueue[t][0]) {
      (ct(`linkifyjs: plugin "${e}" already registered - will be overwritten`),
        (v.pluginQueue[t] = [e, n]));
      return;
    }
  (v.pluginQueue.push([e, n]),
    v.initialized &&
      ct(
        `linkifyjs: already initialized - will not register plugin "${e}" ${Pt}`,
      ));
}
function Ut() {
  v.scanner = Nt(v.customSchemes);
  for (let e = 0; e < v.tokenQueue.length; e++)
    v.tokenQueue[e][1]({ scanner: v.scanner });
  v.parser = xt(v.scanner.tokens);
  for (let e = 0; e < v.pluginQueue.length; e++)
    v.pluginQueue[e][1]({ scanner: v.scanner, parser: v.parser });
  return ((v.initialized = !0), v);
}
function pt(e) {
  return (v.initialized || Ut(), Dt(v.parser.start, e, vt(v.scanner.start, e)));
}
pt.scan = vt;
var I = Tt(bt(), 1);
function Mt(e, n, t) {
  ...
  for (let o = 0; o < r.length; o++) {
    const s = r[o];
    if (s.t === "nl" && n.get("nl2br")) {
      const l = `__linkify-el-${t.elementId++}`;
      i.push(I.createElement("br", { key: l }));
    } else if (!s.isLink || !n.check(s)) i.push(s.toString());
    else {
      let l = n.render(s);
      if (!("key" in l.props)) {
        const u = `__linkify-el-${t.elementId++}`,
          d = Object.assign({ key: u }, l.props);
        l = I.cloneElement(l, d);
      }
      i.push(l);
    }
  }
...
function yt(e, n, t) {
  if (I.Children.count(e.props.children) === 0) return e;
  const r = [];
  I.Children.forEach(e.props.children, (s) => {
    typeof s == "string"
      ? r.push.apply(r, Mt(s, n, t))
      : I.isValidElement(s)
        ? typeof s.type == "string" &&
          n.ignoreTags.indexOf(s.type.toUpperCase()) >= 0
          ? r.push(s)
          : r.push(yt(s, n, t))
        : r.push(s);
  });
  const i = `__linkify-el-${t.elementId++}`,
    o = Object.assign({ key: i }, e.props);
  return I.cloneElement(e, o, r);
}
var _t = (e) => {
  let n = 0;
  const t = ({ tagName: l, attributes: u, content: d }) => (
      (u.key = `__linkify-lnk-${n++}`),
      u.class && ((u.className = u.class), delete u.class),
      I.createElement(l, u, d)
    ),
    r = { key: "__linkify-wrapper" };
  for (const l in e)
    l !== "options" &&
      l !== "as" &&
      l !== "tagName" &&
      l !== "children" &&
      (r[l] = e[l]);
  const i = new Ze(e.options, t),
    o = e.as || e.tagName || I.Fragment || "span",
    s = e.children;
  return yt(I.createElement(o, r, s), i, { elementId: 0 });
};
export { Ft as i, b as n, Se as r, _t as t };
